...
import { DatabaseTypings } from "@lib/utils/database";
...
// works great
export const zCountryCodes = z.enum(COUNTRY_CODES)

// these types are all equivalent
export type CountryCode = (typeof COUNTRY_CODES)[number]
// export type CountryCodeSchema = z.infer<typeof zCountryCodes>

export type Currencies = "cad" | "usd" | string // Currently we only support cad
