...
const sortOptions = [
  { name: 'Latest first', href: '#' },
  { name: 'Earliest first', href: '#' },
  { name: 'Highest First', href: '#' },
  { name: 'Lowest First', href: '#' },
]
const filters = [
  {
    id: 'category',
          ...
          <div className="flex items-center justify-between">
            ...
            <Popover.Group className="hidden sm:flex sm:items-baseline sm:space-x-8">
              {filters.map((section, sectionIdx) => (
                ...
                >
                  <div>
                    <Popover.Button className="focus:outline-none group inline-flex items-center justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
