...
const Button: React.FC<ButtonProps> = ({ text, style, onClick, isLoading = false, icon }) => {
  ...
  return (
    <button 
        className={`cursor-pointer ${buttonStyle} flex justify-center transition delay-50 inline-flex items-center rounded-md border border-transparent px-4 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2`}
        onClick={handleClick} 
