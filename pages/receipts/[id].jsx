                ...
                <div className = 'w-screen h-screen sm:p-12 p-8'>
                    ...
                    <div className="md:flex md:items-center md:justify-between flex">
                        <div className="flex-1 min-w-0">
                            <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">{receipt.donor.first_name}&apos;{receipt.donor.first_name[receipt.donor.first_name.length-1] == "s" ? null : "s"} receipt from {(new Date(Date.parse(receipt.created_at ? receipt.created_at : receipt.date_donated))).toLocaleDateString()}</h2>
                        </div>
                    ...
                    <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                        <div>
                            ...
                            <p className="font-medium text-gray-700">Date Of Donation: {(new Date(Date.parse(receipt.created_at ? receipt.created_at : receipt.date_donated))).toLocaleDateString()}</p>
                        </div>
                        <div>
