    ...
    return (
        <AdminLayout>
            {(user && profile) ? 
                ...
                <div>
                    <PageHeader text={`Generate a donation report`} description={"View and manage donations, resend receipts, and more."} secondaryLinkHref={"#"} secondaryLinkText={"Lookup donation"} primaryLinkText="Resend Receipt" primaryLinkHref={"#"} />
                    <div className="mt-4" />
                    <ResendReceipt />
