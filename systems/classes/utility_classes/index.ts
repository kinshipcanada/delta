...
export const enum EventTypes {
    RECEIPT_ISSUED_AUTOMATICALLY = "RECEIPT_ISSUED_AUTOMATICALLY",
    NOTIFICATION = "NOTIFICATION",
    DONATION_MADE = "DONATION_MADE",
    RECEIPT_ISSUED_MANUALLY = "RECEIPT_ISSUED_MANUALLY",
    USER_UPDATED = "USER_UPDATED",
    INTERNAL_ERROR = "INTERNAL_ERROR",
    STRIPE_CUSTOMER_CREATED = "STRIPE_CUSTOMER_CREATED",
    STRIPE_PAYMENT_METHOD_ATTACHED = "STRIPE_PAYMENT_METHOD_ATTACHED",
}
